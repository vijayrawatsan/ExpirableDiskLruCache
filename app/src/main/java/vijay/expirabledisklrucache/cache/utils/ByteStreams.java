...
public final class ByteStreams {
  ...
  /**
   * There are three methods to implement {@link java.nio.channels.FileChannel#transferTo(long, long,
  ...
  /**
   * Returns an {@link java.io.OutputStream} that simply discards written bytes.
   *
   ...
   * with the same behavior as {@link java.io.DataInput#readFully(byte[])}.
   * Does not close the stream.
   *
   * @param in the input stream to read from.
   * @param b the buffer into which the data is read.
   * @throws java.io.EOFException if this stream reaches the end before reading all
   *     the bytes.
   * @throws java.io.IOException if an I/O error occurs.
   */
   ...
   * {@link java.io.DataInput#readFully(byte[], int, int)}. Does not close the
   * stream.
   *
   * @param in the input stream to read from.
   * @param b the buffer into which the data is read.
